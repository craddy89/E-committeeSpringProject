...
import com.yaksun.ecommitteespringproject.entity.*;
...
public class UserMapper implements Mapper<UserEntity, User> {
    ...
    private com.yaksun.ecommitteespringproject.entity.Role getUserEntityRoleNullSafe(User user) {
        Optional<Role> userRole = Optional.ofNullable(user.getRole());
        return userRole.map(role -> com.yaksun.ecommitteespringproject.entity.Role.valueOf(role.name())).orElse(null);
    }

    private Role getUserRoleNullSafe(UserEntity entity) {
        Optional<com.yaksun.ecommitteespringproject.entity.Role> userEntityRole = Optional.ofNullable(entity.getRole());
